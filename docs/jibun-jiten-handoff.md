...
- **発覚した不具合**: よみ問題の連濁ずれ（けん玉→「だま」なのに正解「たま」）。同型の穴を洗う **Phase 3d** へ。指示書あり（docs/jibun-jiten-phase3d-指示書.md）
...
1. **Phase 3d 着手（連濁バグの一括修正と再発防止・Fable 5 推奨）**。指示書: docs/jibun-jiten-phase3d-指示書.md
