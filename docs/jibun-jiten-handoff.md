...
- 次は **Phase 3a**。指示書あり（docs/jibun-jiten-phase3a-指示書.md）。検収方式は照読（sentences-check.html）
...
1. **Phase 3a 着手（10級 問題データ生成・Fable 5 推奨＝台帳の昇格予定局面§2-2-2）**。指示書: docs/jibun-jiten-phase3a-指示書.md
2. 学年配当読みへの絞り込み → **Phase 3a タスク1（出題読み選定）で10級ぶんを解決する**
