...
- 次は **Phase 3b（ためす＋もどってくる）**。指示書あり（docs/jibun-jiten-phase3b-指示書.md）
...
1. **Phase 3b 着手（ためす＋もどってくる・Fable 5 推奨）**。指示書: docs/jibun-jiten-phase3b-指示書.md
2. ~~学年配当読みへの絞り込み~~ → 10級ぶんは Phase 3a の出題読み選定で解決済み
3. **未解決: 例文164文の照読＝一般公開前の必須項目**（照読は後回し・試用しながら修正する方式で進行中。sentences-check.html で随時指摘可）
